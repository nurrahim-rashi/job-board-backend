...
import {
  ...
  getMyApplicationDetailController,
  getMyJobApplicationController,
  listMyApplicationsController,
  listMyApplicationsPageController,
  submitExpectedSalaryController,
...
applicationRoutes.patch(
  "/applications/me/:applicationId/expected-salary",
  ...applicant,
  submitExpectedSalaryController,
);
