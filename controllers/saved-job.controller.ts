...
export async function unsaveJobController(req: Request, res: Response) {
  await unsaveJob(
    (req as AuthenticatedRequest).user.id,
    String(req.params.slug),
  );
...
export async function listMySavedJobsController(req: Request, res: Response) {
...
export async function listMySavedJobIdsController(req: Request, res: Response) {
